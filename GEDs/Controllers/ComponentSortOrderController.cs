...
{
    public class ComponentSortOrderController : SortOrderController<ComponentOrderPriority>
    {
        public ComponentSortOrderController()
        {
            unitOfWork = new UnitOfWork(new GedsContext());
            sortOrderManager = new SortOrderManager<ComponentOrderPriority>(unitOfWork);
        }
